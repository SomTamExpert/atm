package ch.swiss.nex.km.springbootvuecrudapp.controller;
...
import ch.swiss.nex.km.springbootvuecrudapp.repository.TutorialRepository;

/**
 * Tutorial Controller provides APIs for crud-opertations
 * 
 * @author marco karof
 * @version 31.01.2022
 * 
...
// body.
// – @RequestMapping("/api") declares that all Apis’ url in the controller will
// start with /api.
// – @Autowired is used to inject TutorialRepository bean to local variable.
